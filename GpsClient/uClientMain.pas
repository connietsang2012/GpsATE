...
begin
    ...
    else if User.TestPlan='GPSTest' then
        ac_GPSTest.Execute
    else if User.TestPlan='CoupleTest' then
        ac_CoupleTest.Execute
        
    else if User.TestPlan='WriteImei' then
        ac_WriteImeiTest.Execute
    else if User.TestPlan='ParamDownload' then
        ac_ParamDownloadTest.Execute
    else if User.TestPlan='CartonBox' then
        ShowCartonBoxForm()
    else if User.TestPlan='AutoTest' then
        ac_AutoTest.Execute
    else if User.TestPlan='TwiceTest' then
        ac_Twice.Execute;
end;
//==================================================================//
...
begin
    ...
    try
        ...
        else if strCmdKey[CommIndex]='CheckTestedParamCpd' then //2014.12.3新加流程检测是否跑过下载位
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='CheckTested' then
        begin
        ...
        else if strCmdKey[CommIndex]='CheckTested_SetResult' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='CheckTested_SMT' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='GetTempRid' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='CheckMustTest' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
                ...
                begin
                    ...
                    else if strPlanName='ParamDownload' then
                    begin
        ...
        else if strCmdKey[CommIndex]='CheckTestedBySNAndVersion' then
        begin
           if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='CheckTestPass_WriteIMEI' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                if StrListNumberSign[CommIndex].Count>1 then
        ...
        else if strCmdKey[CommIndex]='GetTempImei' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='GetTestPlanItem' then
        begin
        ...
        else if strCmdKey[CommIndex]='UpdateGpsTcData' then
        begin
            //--------------------------Action=GetTestPlanItem#SoftModel=GT06B#TestPlan=2#--------------------------//
            //--------------------------'Action=GetTestPlanItem#%s#',[strTemp]--------------------------//
            if StrListNumberSign[CommIndex].Count>1 then
        ...
        else if strCmdKey[CommIndex]='UpdateResult' then
        begin
        ...
        else if strCmdKey[CommIndex]='CheckTestPass' then
        begin
        ...
        else if strCmdKey[CommIndex]='CheckIMEI' then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if strCmdKey[CommIndex]='DeleteImei' then
        begin
        ...
        else if (strCmdKey[CommIndex]='DeleteTestResult_Twice')  then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if (strCmdKey[CommIndex]='TwiceByUpdateVersion')  then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
                SendToServer(CommIndex);
        ...
        else if (strCmdKey[CommIndex]='DeleteTestResult_ByBoxNo_Twice') then
        begin
            if StrListNumberSign[CommIndex].Count>1 then
            begin
               SendToServer(CommIndex);
        ...
        else if (strCmdKey[CommIndex]='CalculateCRC') then
        begin
           if StrListNumberSign[CommIndex].Count>1 then
            begin
               SendToServer(CommIndex);
