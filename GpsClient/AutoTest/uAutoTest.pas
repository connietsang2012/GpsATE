                                    ...
                                    begin
                                        ...
                                        begin
                                            ...
                                            if iIndex = 0 then strValue := StrListMTKBMT[CommIndex][0]
                                                ...
                                                if iIndex = 1 then strValue := StrListMTKBMT[CommIndex][3]
                                                else
                                                    if iIndex = 2 then strValue := StrListMTKBMT[CommIndex][4];
                                        end
                                        else
                                            if Pos('GPSTIME', strRemark[CommIndex]) > 0 then
                                                //else if strRemark[CommIndex]='GPSTIME' then
                                            begin
                                                strValue := FloatToStr(PositionGpsTime[CommIndex]);
                                            end
                                            else
                                                if Pos('IMSI', strRemark[CommIndex]) > 0 then
                                                begin
