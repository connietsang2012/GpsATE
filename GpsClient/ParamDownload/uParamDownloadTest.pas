        ...
        case TestResult of
          ...
          1:
                begin
                  ...
                  else if strParamDownTestValue[CommIndex]='VERSIONS' then
                  begin
                      strParamDownTestValue[CommIndex]:='';
...
begin
    ...
    try
        ...
        else if (strRemark[CommIndex]='VERSIONMODE') then //server端配置修改版本指令
        begin
        ...
        else if (strCmdCommKey[CommIndex]= 'VERMODE') then
        begin
        ...
        else if strCmdCommKey[CommIndex]='ATPARAMVERSION' then//读下载参数后新版本
        begin
