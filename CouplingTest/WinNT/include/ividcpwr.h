...
#define IVIDCPWR_MAJOR_VERSION              (1L)
...
#define IVIDCPWR_ATTR_NUM_CHANNELS              IVI_ATTR_NUM_CHANNELS                  /* ViInt32,  read-only */
...
#define IVIDCPWR_ATTR_IO_SESSION_TYPE                  IVI_ATTR_IO_SESSION_TYPE                /* ViString, read-only */ 
#define IVIDCPWR_ATTR_IO_SESSION                       IVI_ATTR_IO_SESSION                     /* ViString, read-only */
