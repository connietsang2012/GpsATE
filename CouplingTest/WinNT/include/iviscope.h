...
#define IVISCOPE_MAJOR_VERSION                  (2L)
#define IVISCOPE_MINOR_VERSION                  (10L)

#define IVISCOPE_SPECIFICATION_MAJOR_VERSION    (2L)
...
#define IVISCOPE_ATTR_NUM_CHANNELS              IVI_ATTR_NUM_CHANNELS                  /* ViInt32,  read-only */
