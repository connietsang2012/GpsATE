 ...
 *                            I V I - F G E N
 *-----------------------------------------------------------------------------
 *    Copytight (c) National Instruments 1998.  All Rights Reserved.
 *-----------------------------------------------------------------------------
 *
 * Title:       ivifgen.h
...
#define IVIFGEN_MAJOR_VERSION               (2L)
#define IVIFGEN_MINOR_VERSION               (0L)

#define IVIFGEN_CLASS_SPEC_MAJOR_VERSION    (2L)
...
#define IVIFGEN_ATTR_NUM_CHANNELS              IVI_ATTR_NUM_CHANNELS                /* ViInt32,  read-only */
