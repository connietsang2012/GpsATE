object frmAutoTestItemPlan: TfrmAutoTestItemPlan
  Left = 281
  Top = 138
  Width = 928
  Height = 480
  Caption = #33258#21160#27979#35797#35745#21010
  Color = clBtnFace
  ...
  object UniQuery_DstSubItem: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from Gps_AutoTest_DstSubItem WHERE Gps_AutoTest_DstSubI' +
        'tem.ItemModel=:ItemModel')
  ...
  object UniQuery_SrcSubItem: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from Gps_AutoTest_SrcSubItem  WHERE Gps_AutoTest_SrcSub' +
