object frmParamDownloadPlan: TfrmParamDownloadPlan
  Left = 86
  Top = 156
  Width = 928
  Height = 480
  Caption = #21442#25968#19979#36733#35745#21010
  Color = clBtnFace
  ...
  object UniQuery_DstSubItem: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from Gps_ParamDownload_DstSubItem WHERE Gps_ParamDownlo' +
        'ad_DstSubItem.ItemModel=:ItemModel')
  ...
  object UniQuery_SrcSubItem: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from Gps_ParamDownload_SrcSubItem  WHERE Gps_ParamDownl' +
        'oad_SrcSubItem.ItemModel=:ItemModel')
    RefreshOptions = [roAfterInsert, roAfterUpdate, roBeforeEdit]
    Active = True
    Left = 456
    Top = 168
