...
type
  TfrmAutoTestSMTItemPlan = class(TForm)
    pnl1: TPanel;
    lbl1: TLabel;
...
var
  frmAutoTestSMTItemPlan: TfrmAutoTestSMTItemPlan;
  stem : string;
...
{$R *.dfm}
procedure TfrmAutoTestSMTItemPlan.FormCreate(Sender: TObject);
begin
...
procedure TfrmAutoTestSMTItemPlan.cbbCom_TestModelChange(Sender: TObject);
var
...
procedure TfrmAutoTestSMTItemPlan.SetButtons;
var
...
procedure TfrmAutoTestSMTItemPlan.btnIncludeClick(Sender: TObject);
begin
...
procedure TfrmAutoTestSMTItemPlan.btnExcludeClick(Sender: TObject);
begin
  if Length(Trim(cbbCom_TestModel.Text)) > 0 then
  begin
...
procedure TfrmAutoTestSMTItemPlan.btnExAllClick(Sender: TObject);
begin
  if Length(Trim(cbbCom_TestModel.Text)) > 0 then
  begin
...
procedure TfrmAutoTestSMTItemPlan.btnIncAllClick(Sender: TObject);
begin
  if Length(Trim(cbbCom_TestModel.Text)) > 0 then
  begin
...
procedure TfrmAutoTestSMTItemPlan.FormShow(Sender: TObject);
var
  i:Integer;
begin
