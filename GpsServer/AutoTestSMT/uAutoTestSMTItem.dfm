inherited frmAutoTestSMTItem: TfrmAutoTestSMTItem
  Left = 75
  Top = 167
  Height = 666
  Caption = #33258#21160#27979#35797#39033#30446#35774#32622'(SMT)'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 11
  ...
  inherited DS_Module: TDataSource
    DataSet = UniQuery_AutoTestSMTSubItem
    Top = 40
  end
  ...
  object UniQuery_AutoTestSMTItem: TUniQuery
    Connection = DMMain.UniConGpsTest
    SQL.Strings = (
      'select * from Gps_AutoTestSMTItem'
    ...
    object SFUniQuery_AutoTestSMTItemItemModel: TStringField
      FieldName = 'ItemModel'
      Required = True
    end
    object SFUniQuery_AutoTestSMTItemItemName: TStringField
      FieldName = 'ItemName'
      Required = True
      Size = 50
    end
  end
  object UniQuery_AutoTestSMTSubItem: TUniQuery
    Connection = DMMain.UniConGpsTest
    SQL.Strings = (
      'select * from Gps_AutoTestSMTSubItem')
    BeforeInsert = UniQuery_AutoTestSMTSubItemBeforeInsert
    AfterInsert = UniQuery_AutoTestSMTSubItemAfterInsert
    Left = 712
    Top = 40
  end
  object DS_AutoTestItem: TDataSource
    DataSet = UniQuery_AutoTestSMTItem
    Left = 680
    Top = 8
  end
