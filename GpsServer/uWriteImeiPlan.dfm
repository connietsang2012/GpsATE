object frmWriteImeiPlan: TfrmWriteImeiPlan
  Left = 265
  Top = 273
  Width = 979
  Height = 557
  ...
  object pgc1: TPageControl
    ...
    object ts1: TTabSheet
      ...
      object dblklstId: TDBLookupListBox
        Left = 7
        Top = 20
        Width = 122
        Height = 290
      ...
      object dblklstId1: TDBLookupListBox
        Left = 154
        Top = 20
        Width = 122
        Height = 290
  ...
  object UniQuery_SrcSubItem: TUniQuery
    ...
    SQL.Strings = (
        ...
        'select * from Gps_WriteImei_SrcSubItem WHERE Gps_WriteImei_SrcSu' +
        'bItem.ItemModel=:ItemModel')
    RefreshOptions = [roAfterInsert, roAfterUpdate, roBeforeEdit]
    Left = 448
    Top = 168
